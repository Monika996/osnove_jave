...
//		  u main funkciji, napraviti visa i master kartice i testirati funkcije
	...
	public MasterCard(double suma, String brojKartice, int godinaVazenja, int mesecVazenja, String ovlascenoLice) {
		super(suma, brojKartice, godinaVazenja, mesecVazenja);
	}

	@Override
	public void izvrsiTransakciju(int vrednost) {
		double x = (vrednost * 1.5) / 100;

		this.suma = this.suma - (x + vrednost);
	}
