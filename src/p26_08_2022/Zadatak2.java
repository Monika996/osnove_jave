...
//		  u main funkciji, napraviti visa i master kartice i testirati funkcije
	...
	public static void main(String[] args) {
		VisaKartica visa = new VisaKartica(450, "23642-237482", 2025, 12, "Monika Nikolic");
		visa.dodajSredstva(200);
		visa.izvrsiTransakciju(40);
		visa.stampaj();

		MasterCard master = new MasterCard(560, "32684-3742", 2023, 11, "Jakov Janicijevic");
