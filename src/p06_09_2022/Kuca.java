...
//
	...
	public Kuca(String ulicaIBroj, int povrsina, int zona, String brojClanova) {
	...
	@Override
	public void print() {
		System.out.println("Adresa kuce je: " + this.ulicaIBroj);
		System.out.println("Povrsina kuce je: " + this.povrsina);
		System.out.println("Zona u kojoj se nalazi kuca je: " + this.zona);
		System.out.println("Broj clanova u kuci je: " + this.brojClanova);
