...
//			Naravno u glavnom kreirati objekte i testirati funkcionalnosti 
	...
	public static void main(String[] args) {
		Racun monika = new Racun("Monika Nikolic ", "180-4754-13704 ", 30000000);
		Racun milos = new Racun("Milos Ognanovic ", "180-237-3472 ", 200000);
		monika.print();
		milos.print();

		Transakcija transakcija1 = new Transakcija("029 ", monika, milos);
		transakcija1.izvrsiTransakciju(6000);
		transakcija1.print();
		monika.print();
		milos.print();
