...
//		U glavnom programu kreirati jednu Korpu i u nju dodati nekoliko Ambalaza razlicitih tipova i istestirati sve metode i ispisati ukupnu cenu sa popustom.
		...
		Ambalaza tetrapak = new Tetrapak("374203-hcf28374", "Sok", 1500, 1000, true, 150);
		Ambalaza staklenaAmbalaza = new StaklenaAmbalaza("473929hfw-3247e", "Vino", 1000, 1200, 50, true, 700);
		SuperKartica s = new SuperKartica("792345-324789", "Monika Nikolic", 120);

		Korpa k = new Korpa();
		k.dodajAmbalazu(tetrapak);
		k.dodajAmbalazu(staklenaAmbalaza);
		tetrapak.print();
		staklenaAmbalaza.print();
