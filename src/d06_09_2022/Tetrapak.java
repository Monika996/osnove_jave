...
//	U glavnom programu kreirati jednu Korpu i u nju dodati nekoliko Ambalaza razlicitih tipova i istestirati sve metode i ispisati ukupnu cenu sa popustom.
	...
	public Tetrapak(String barKod, String nazivArtikla, double brutoTezina, double netoTezina, boolean reciklaza,
			double osnovnaCena) {
	...
	public void print() {
		...
		System.out.println("Bruto tezina je: " + this.brutoTezina + "g");
		System.out.println("Neto tezina je: " + this.netoTezina + "g");
		System.out.println("Da li se moze reciklirati " + this.reciklaza);
		System.out.println("Osnovna cena je: " + this.osnovnaCena + "rsd");
